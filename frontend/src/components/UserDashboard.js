...
const Dashboard = () => {
  ...
  const totalAmount = invoices.reduce(
    (acc, curr) => acc + curr.bill.totalAmount,
    0
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 pt-24">
        ...
        <div className="grid grid-cols-2 gap-8">
          {/* Amount Trend */}
          <div
            className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 
          ...
          {/* Receipt History */}
          <div
            className="col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 
            hover:shadow-xl transition-all duration-300 hover:bg-white"
          >
            <h2 className="text-lg font-semibold text-gray-800 mb-4">
              Recent Receipts
            ...
            <div className="overflow-auto max-h-96">
              <table className="min-w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {invoices
                    .filter(
                      (invoice) => new Date(invoice.createdAt) >= thirtyDaysAgo
                    )
                    .sort(
